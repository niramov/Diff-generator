...
import { getAbsolutePath, readData, getExtention } from './utils.js';
...
const gendiff = (filepath1, filepath2, formatName = 'stylish') => {
  ...
  const parsedData1 = parse(data1, getExtention(path1));
  const parsedData2 = parse(data2, getExtention(path2));
